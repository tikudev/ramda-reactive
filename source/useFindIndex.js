...
import { findIndex, curryN } from 'ramda'
...
*/
const useFindIndex = curryN(2,(fn, list) => computed(() => findIndex(typeof fn === 'function' ? (...fnArgs) => unref(unref(fn)(...fnArgs)) : unref(fn), typeof list === 'function' ? list() : unref(list))))
